...
ActiveRecord::Schema[8.1].define(version: 2026_05_13_000003) do
  ...
  create_table "agents", force: :cascade do |t|
    ...
    t.check_constraint "level >= 1 AND level <= 10", name: "level_between_1_and_10"
  end
  ...
  create_table "missions", force: :cascade do |t|
    ...
    t.check_constraint "status IN ('assigned', 'in_progress', 'completed')", name: "status_is_known_mission_status"
  end
